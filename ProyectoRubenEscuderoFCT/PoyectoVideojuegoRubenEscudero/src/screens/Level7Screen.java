...
import characters.BossLevel7;
import characters.Enemy;
import characters.Enemy2;
import characters.Enemy3;
import characters.EnemyExtra2;
...
/**
 * Class to play level 7
 * @author ruben
 * @since 22/04/2020
 */
public class Level7Screen extends BaseScreen{
	...
	public void initialize() {
		...
		background.loadTexture("assets/backgrounds/extra2.jpg");
        ...
        boss = new BossLevel7(0, 600, mainStage);
        boss.setLife(8000);
        ...
        try {
			...
			basePoints = Integer.parseInt(properties.getProperty("actualpoints7"));
	...
	public void update(float dt) {
        ...
        for(BaseActor spaceBullet: BaseActor.getList(mainStage, SpaceBullet2.class.getName())) {
        	...
        	for(BaseActor enemy: BaseActor.getList(mainStage, EnemyExtra2.class.getName())) {
        ...
        */
        ...
        if(bossDie) {
            ...
            if(points > basePoints) {
            	properties.setProperty("actualpoints7", String.valueOf(points));
            	try {
        ...
        boss.setY(yBossPosition + player.getY() + 450);
	...
	private void newEnemy() {
		long time = System.currentTimeMillis();
		if(lastEnemy - time < -1000) {
			lastEnemy = time;
			EnemyExtra2 enemy = new EnemyExtra2(MathUtils.random(0, 450), player.getY() + 650, mainStage);
		}
	}
